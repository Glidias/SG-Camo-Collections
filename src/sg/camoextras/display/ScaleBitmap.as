...
package sg.camoextras.display {
	...
	/**
	 * Bitmap with scale9Grid support. <br/><br/>
	 * Original implementation at: http://www.bytearray.org/?p=118<br/>
	 * Repackaged under SG-Camo to allow seamless integration with <i>SkinBehaviour</i>.
	 * @see sg.camo.behaviour.SkinBehaviour
	 * 
	 */
	public class ScaleBitmap extends Bitmap implements IResizable, IDestroyable {
		...
		private function assignBitmapData(bmp : BitmapData) : void {
			if (bitmapData != null) super.bitmapData.dispose();
		...
		/**
		 * Resizes bitmap and adjusts according to scale9Grid (if available).
		 */
